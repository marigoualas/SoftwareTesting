...
public class Task3_2 {
    ...
    @Test
    public void test2() {
        /*MatchString s1 = RegExpMatcher.make2();
        MatchString s2 = RegExpMatcher.make5();
        MatchString s3 = RegExpMatcher.make5();
        MatchString final0 = RegExpMatcher.makeConcatenation(s1, s2);
        MatchString final1 = RegExpMatcher.makeConcatenation(final0, s3);
        MatchString s4 = RegExpMatcher.make0();
        MatchString s5 = RegExpMatcher.make1();
        MatchString s6 = RegExpMatcher.makeConcatenation(s5, s4);
        MatchString s7 = RegExpMatcher.makeConcatenation(s4, s4);
        MatchString s8 = RegExpMatcher.makeConcatenation(s6, s7);
        REstring s9 = RegExpMatcher.makeRange(s4, s8);
        assertFalse(RegExpMatcher.matches(final1, s9));*/
    ...
    public void test13() {
        assertFalse(RegExpMatcher.matches(new MatchString("marios@gmail.com"), new REstring("^[a-zA-Z0-9_!#$%&'*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+$\"")));
    }
    
    @Test
    public void test14() {
        assertTrue(RegExpMatcher.matches(new MatchString("foo@bar.co.uk"), new REstring("([a-zA-Z0-9])+\\@([a-zA-Z0-9])+\\.([a-z.]){2,}")));
    }
